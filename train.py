...
flags.DEFINE_string('model', 'yolov3-tiny', 'yolov4, yolov3 or yolov3-tiny')
flags.DEFINE_string('weights', './data/yolov3-tiny.weights', 'pretrained weights')
    ...
    for epoch in range(first_stage_epochs + second_stage_epochs):
        if epoch < first_stage_epochs:
            if not isfreeze:
                ...
                for name in ['conv2d_9', 'conv2d_12']:
